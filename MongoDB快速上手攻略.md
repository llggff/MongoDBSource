...
##### 3.     **将****MongoDB** **中的数据****JavaBean****的形式取出**
...
​	需要将更新的数据一个一个进行拼接，但是如果javabean属性比较多，拼起来将非常麻烦，而且还要考虑每一个属性是否为null ，为此下面这个工具类将是你的不二之选   ![1538292128126](assets/1538292128126.png)
